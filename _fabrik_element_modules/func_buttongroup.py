"""
Function to modify the joomla fabrik button group field in the radiobutton plugin
...
# INDEX
"""
update_button_group - Function to update joomla fabrik table button group
"""


def update_button_group(mysql_cxn, s_table: str = '', s_name: str = '', s_label: str = '') -> bool:
    """
    ...
    for row in o_records:
        ...
        if '"btnGroup":"0"' in s_data and '0' != s_label:
            l_updated = True
            s_data = s_data.replace('"btnGroup":"0"', '"btnGroup":"' + s_label + '"')
        elif '"btnGroup":"1"' in s_data and '1' != s_label:
            l_updated = True
            s_data = s_data.replace('"btnGroup":"1"', '"btnGroup":"' + s_label + '"')
        # print(s_data)
    ...
    if func_configure.l_log_project:
        func_file.write_log('%t UPDATE BUTTON GROUP: ' + s_name + ' to ' + s_label, func_configure.s_path_project + 'log/')
...
if __name__ == '__main__':
    try:
        ...
        update_button_group(sql_cxn, s_tab, 'ia_findlike_active', '1')
