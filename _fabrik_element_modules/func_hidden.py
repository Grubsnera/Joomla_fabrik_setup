"""
Function to modify the joomla fabrik hidden field
...
# INDEX
"""
update_hidden - Function to update joomla fabrik table hidden value
"""


def update_hidden(mysql_cxn, s_table: str = '', s_name: str = '', i_value: int = 0) -> bool:
    """
    ...
    if func_configure.l_debug_project:
        print('Updated: Fabrik hidden ' + s_name + ' to ' + str(i_value))
    if func_configure.l_log_project:
        func_file.write_log('%t UPDATE HIDDEN: ' + s_name + ' to ' + str(i_value),
...
if __name__ == '__main__':
    try:
        ...
        update_hidden(sql_cxn, s_tab, 'ia_findlike_auto', 0)
